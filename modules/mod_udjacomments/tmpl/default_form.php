...
<form name="frmCommentPost" id="frmCommentPost" action="<?php echo $currentUrl; ?>#frmCommentPost" method="post">
	...
	<fieldset class="commentFields">
		...
		<p class="textboxWrapper">
			<label for="txtUdjaName"><?php echo JText::_('MOD_UDJACOMMENTS_FORM_LBLNAME') ?><span class="required">*</span></label></br>
		...
		<div class="clear"></div>
		<p class="textboxWrapper">
			<label for="txtUdjaEmail"><?php echo JText::_('MOD_UDJACOMMENTS_FORM_LBLEMAIL') ?><?php if ($helper->getRequired('email')) { echo '<span class="required">*</span>'; } ?></label></br>
		...
		<div class="clear"></div>
		<p class="textboxWrapper">
			<label for="txtUdjaWebsite"><?php echo JText::_('MOD_UDJACOMMENTS_FORM_LBLWEBSITE') ?><?php if ($helper->getRequired('url')) { echo '<span class="required">*</span>'; } ?></label></br>
		...
		<p class="textareaWrapper">
			<label for="txtUdjaComment"><?php echo JText::_('MOD_UDJACOMMENTS_FORM_LBLCOMMENT') ?><span class="required">*</span></label></br>
		...
		<?php endif; ?>
		<div class="clear"></div>
		<?php if ($helper->getParam('enable_notifications')) : ?>
		...
		<?php endif; ?>
		<div class="clear"></div>
		<?php if ($helper->getParam('enable_signup')) : ?>
			<p class="checkboxWrapper">
